// Egyetlen Cloudflare Worker: statikus fájlokat szolgál ki (public/ mappa),
// és a /api/check útvonalat maga kezeli (URL-elérhetőség ellenőrzés).
...
export default {
  async fetch(request, env) {
    ...
    // Minden más útvonalat a public/ mappából szolgálunk ki statikusan.
